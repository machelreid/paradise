...
@register_task("multilingual_denoising_dictionary")
class MultilingualDenoisingDictionaryTask(DenoisingTask):
    @staticmethod
    def add_args(parser):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if split == self.args.train_subset:
            ...
            sample_probs = self._get_sample_prob(dataset_lengths, languages)
            logger.info(
